...
namespace Qasedak.Modules.Conversations.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260907053239_AddHistoryImportAndScopedProviderMessageId")]
    partial class AddHistoryImportAndScopedProviderMessageId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Qasedak.Modules.Conversations.Domain.Conversations.Conversation", b =>
                {
                    ...
                    b.HasIndex("WorkspaceId", "Channel", "ChannelAccountId", "ParticipantId")
                        .IsUnique()
