...
### Community 30 - "Qasedak.Modules.Identity.Application.Authentication"
Cohesion: 0.10
...
### Community 55 - "Qasedak.Modules.Instagram.Application.Webhooks"
Cohesion: 0.11
...
### Community 105 - "AccountsScreen.tsx"
Cohesion: 0.26
...
### Community 108 - ".FindByWorkspaceAsync"
Cohesion: 0.30
...
### Community 110 - "IWebhookPostIngestProcessor"
Cohesion: 0.18
...
### Community 127 - "EfConnectedAccountRepository"
Cohesion: 0.41
...
### Community 148 - "20260823110059_InitialIdentityCreation.Designer.cs"
Cohesion: 0.20
...
### Community 149 - "IWebhookInboxStore"
Cohesion: 0.40
...
### Community 151 - "ContactPersistenceTests"
Cohesion: 0.47
...
### Community 187 - ".AddIdentityModule"
Cohesion: 0.50
...
### Community 198 - "check_environment_contract.py"
Cohesion: 0.83
...
- **Why does `Qasedak.BuildingBlocks.Application` connect `Qasedak.BuildingBlocks.Application` to `Qasedak.BuildingBlocks.Infrastructure/DependencyInjection.cs`, `LoggerMessage`, `Qasedak.Modules.Conversations.Application.Conversations`, `.ExecuteAsync`, `FixedClock`, `Qasedak.BuildingBlocks.Infrastructure`, `.DispatchAsync`, `Qasedak.Modules.Automations.Application`, `Qasedak.slnx`, `.ExecuteAsync`, `.ProcessPendingAsync`, `.HandleAsync`, `Qasedak.Modules.Instagram.Application.Webhooks`, `Qasedak.Modules.Identity.Application.Authentication`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `Qasedak.Api.IntegrationTests` connect `Qasedak.Api.IntegrationTests` to `ApiPostgreSqlFixture`, `DatabaseMigratorTests`, `Qasedak.Modules.Automations.Application`, `Qasedak.Modules.Billing.Domain`, `CorrelationEndpointTests`, `IdentityAuthorizationTests`, `.PublicEndpointsThrottlePerSourceWith429AndRetryAfter`, `Qasedak.Modules.Instagram.Application.Webhooks`, `WebhookToContactProjectionTests`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `Qasedak.Modules.Instagram.Application.Webhooks` connect `Qasedak.Modules.Instagram.Application.Webhooks` to `LoggerMessage`, `BillingEndpointTests`, `WebhookMetrics`, `HmacWebhookSignatureVerifier`, `.DispatchAsync`, `Qasedak.Modules.Automations.Application`, `IWebhookPostIngestProcessor`, `.ProcessPendingAsync`, `WebhookInboxTests`, `.DispatchAsync`, `.Validate`, `Qasedak.BuildingBlocks.Application`?**
